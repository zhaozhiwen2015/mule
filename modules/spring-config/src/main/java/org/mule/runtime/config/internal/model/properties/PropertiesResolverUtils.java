...
import static org.mule.runtime.api.config.Feature.HONOUR_RESERVED_PROPERTIES;
...
public class PropertiesResolverUtils {
   ...
   * or equal to 4.2.2, or if system property {@link Feature#HONOUR_RESERVED_PROPERTIES} is set. See MULE-17659 and MULE-19038.
   *
   * @since 4.4.0 4.3.0
   */
